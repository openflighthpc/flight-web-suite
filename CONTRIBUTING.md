# Contributing to Flight Web Suite

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Web Suite? Welcome! Please read this
...
You can help Flight Web Suite by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-web-suite/issues?state=open)
...
If you find a bug - behaviour of Flight Web Suite code or documentation
...
[GitHub issue tracker for Flight Web Suite](https://github.com/openflighthpc/flight-web-suite/issues/new)
to report the issue.
...
We want to improve the quality of Flight Web Suite and good bug reports are
...
Flight Web Suite is Open Source and comes without warranty.
...
Flight Web Suite in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Web Suite and really improve it. The more
...
applied to Flight Web Suite itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-web-suite). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Web Suite developers also have their regular
